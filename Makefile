...
coverage:
	...
	TEST_BIN=$$(find .build/debug -name "swift-srt-kitPackageTests" -type f ! -name "*.o" -not -path "*.dSYM*" | head -1); \
...
help:
	@echo "swift-srt-kit — Makefile targets"
	@echo ""
